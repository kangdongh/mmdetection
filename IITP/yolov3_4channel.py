...
model = dict(
    ...
    backbone=dict(type='Darknet', depth=53, out_indices=(3, 4, 5), in_channels=4),
    neck=dict(
        type='YOLOV3Neck',
        num_scales=3,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/train-night-02.json',
        img_prefix=data_root + 'images/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/test-night-20.json',
        img_prefix=data_root + 'images/',
